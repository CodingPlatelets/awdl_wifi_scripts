...
curl -s https://raw.githubusercontent.com/CodingPlatelets/awdl_wifi_scripts/main/disable_awdl.sh > ~/disable_awdl.sh
sudo chmod u+x ~/disable_awdl.sh
cd /Library/LaunchDaemons/ && sudo curl -sO https://raw.githubusercontent.com/CodingPlatelets/awdl_wifi_scripts/main/com.meter.wifi.awdl.plist
